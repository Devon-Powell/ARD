...
public class @PlayerInputSystem : IInputActionCollection, IDisposable
{
    ...
    private IARDControlsActions m_ARDControlsActionsCallbackInterface;
    ...
    public struct ARDControlsActions
    {
        ...
        {
            if (m_Wrapper.m_ARDControlsActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnMove;
                @PunchLeft.started -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnPunchLeft;
                @PunchLeft.performed -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnPunchLeft;
                @PunchLeft.canceled -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnPunchLeft;
                @PunchRight.started -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnPunchRight;
                @PunchRight.performed -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnPunchRight;
                @PunchRight.canceled -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnPunchRight;
                @ReachLeft.started -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnReachLeft;
                @ReachLeft.performed -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnReachLeft;
                @ReachLeft.canceled -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnReachLeft;
                @ReachRight.started -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnReachRight;
                @ReachRight.performed -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnReachRight;
                @ReachRight.canceled -= m_Wrapper.m_ARDControlsActionsCallbackInterface.OnReachRight;
